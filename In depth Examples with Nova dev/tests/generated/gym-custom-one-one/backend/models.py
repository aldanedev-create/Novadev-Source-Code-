...
TABLES = {'Member': [{'name': 'id', 'type': 'auto', 'attributes': [], 'auto': True, 'secure': False, 'unique': False}, {'name': 'name', 'type': 'text', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}, {'name': 'email', 'type': 'email', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}, {'name': 'plan', 'type': 'text', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}], 'CheckIn': [{'name': 'id', 'type': 'auto', 'attributes': [], 'auto': True, 'secure': False, 'unique': False}, {'name': 'memberName', 'type': 'text', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}, {'name': 'status', 'type': 'text', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}]}
API_TABLES = {'members': 'Member', 'check-ins': 'CheckIn'}
PRIMARY_KEYS = {'Member': 'id', 'CheckIn': 'id'}
DATA = deepcopy({'Member': [{'id': 1, 'name': 'Name 1', 'email': 'email1@example.com', 'plan': 'Plan 1'}, {'id': 2, 'name': 'Name 2', 'email': 'email2@example.com', 'plan': 'Plan 2'}, {'id': 3, 'name': 'Name 3', 'email': 'email3@example.com', 'plan': 'Plan 3'}], 'CheckIn': [{'id': 1, 'memberName': 'Membername 1', 'status': 'new'}, {'id': 2, 'memberName': 'Membername 2', 'status': 'active'}, {'id': 3, 'memberName': 'Membername 3', 'status': 'review'}]})
