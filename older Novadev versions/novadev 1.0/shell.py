...
"""Interactive shell and shell-side command runner for NovaDev 1.0."""
...
def execute_command(command: str, args: List[str], interpreter: Optional[Interpreter] = None) -> int:
    ...
    if command in {"new", "lint", "format", "docs", "clean", "dev", "install", "update", "remove", "package", "deploy"}:
        import nova
...
def interactive_main() -> int:
    ...
    print("NovaDev 1.0 Interactive Shell")
