...
"""Backend target generators for NovaDev 1.0."""
...
class FastAPIBackendGenerator:
    ...
    def routes_py(self, runtime: Runtime) -> str:
        ...
        return f'''"""Generated NovaDev 1.0 FastAPI routes."""
...
'''
    ...
    def app_py(self) -> str:
        return '''"""Generated NovaDev 1.0 FastAPI app."""
...
class DjangoBackendGenerator:
    ...
    def models_py(self, runtime: Runtime) -> str:
        ...
        return '"""Generated NovaDev 1.0 Django model starter."""\n\nfrom django.db import models\n\n\n' + "\n".join(classes)

    def views_py(self, runtime: Runtime) -> str:
        resources = {api_resource_name(name): name for name in runtime.tables}
        return f'''"""Generated NovaDev 1.0 Django view starter."""
...
def python_table_data(runtime: Runtime) -> str:
    ...
    return f'''"""Generated NovaDev 1.0 table data."""
