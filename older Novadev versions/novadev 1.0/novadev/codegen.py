...
"""Flask backend generator for NovaDev 1.0.
...
class BackendGenerator:
    ...
    def config_py(self, frontend_relative: str) -> str:
        return f'''"""Generated NovaDev 1.0 Flask backend config."""
...
'''
    ...
    def models_py(self, runtime: Runtime) -> str:
        ...
        return f'''"""Generated NovaDev 1.0 model and data helpers."""
...
'''
    ...
    def routes_py(self, runtime: Runtime) -> str:
        ...
        return f'''"""Generated NovaDev 1.0 declared route handlers."""
...
"""
    ...
    def app_py(self, frontend_relative: str) -> str:
        return f'''"""Generated NovaDev 1.0 Flask app.
