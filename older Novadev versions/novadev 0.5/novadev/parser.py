...
"""Recursive-descent parser for NovaDev 0.5.
...
class Parser:
        ...
        while True:
            if self.match("DOT"):
                ...
                if isinstance(expr, IdentifierNode):
                    ...
                    raise NovaSyntaxError("Only identifiers can use dotted calls in NovaDev 0.5", self.previous())
    ...
    def consume_path_name(self, message: str) -> str:
        ...
        name = self.consume_word(message)
        while self.match("DOT"):
            name += "." + self.consume_word("Expected path segment after '.'")
        return name
