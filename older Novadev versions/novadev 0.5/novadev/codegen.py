...
"""Flask backend generator for NovaDev 0.4.
...
class BackendGenerator:
    ...
    def config_py(self, frontend_relative: str) -> str:
        return f'''"""Generated NovaDev 0.5 Flask backend config."""
...
'''
    ...
    def models_py(self, runtime: Runtime) -> str:
        ...
        return f'''"""Generated NovaDev 0.5 model and data helpers."""
...
'''
    ...
    def routes_py(self, runtime: Runtime) -> str:
        ...
        return f'''"""Generated NovaDev 0.5 declared route handlers."""
...
"""
    ...
    def app_py(self, frontend_relative: str) -> str:
        return f'''"""Generated NovaDev 0.5 Flask app.
