...
TABLES = {'Product': [{'name': 'id', 'type': 'auto', 'attributes': [], 'auto': True, 'secure': False, 'unique': False}, {'name': 'name', 'type': 'text', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}, {'name': 'price', 'type': 'money', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}, {'name': 'stock', 'type': 'int', 'attributes': [], 'auto': False, 'secure': False, 'unique': False}]}
API_TABLES = {'products': 'Product'}
PRIMARY_KEYS = {'Product': 'id'}
DATA = deepcopy({'Product': [{'id': 1, 'name': 'Aurora Hoodie', 'price': 68, 'stock': 24}, {'id': 2, 'name': 'Orbit Desk Lamp', 'price': 89, 'stock': 18}, {'id': 3, 'name': 'Nova Tote', 'price': 32, 'stock': 40}, {'id': 4, 'name': 'Focus Bottle', 'price': 28, 'stock': 35}]})
